            ...
            {items.length > 0 && (
              <div className="p-6 bg-stone-900/50 border-t border-white/10 space-y-4">
                ...
                <button
                  ...
                  className="w-full py-4 rounded-2xl bg-amber-500 hover:bg-amber-400 text-stone-950 font-black uppercase tracking-[0.2em] text-sm shadow-[0_20px_40px_rgba(245,158,11,0.2)] transition-all flex items-center justify-center gap-2 group"
                >
